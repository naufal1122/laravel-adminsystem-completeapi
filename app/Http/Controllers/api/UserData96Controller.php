...
class UserData96Controller extends Controller
{
    ...
    public function getUserDetail96(Request $request, $id)
    {
    ...
    public function putUserDetail96(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhoto96(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhotoKTP96(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPassword96(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserAgama96(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'id_agama' => 'required|exists:agama96,id',
        ]);
