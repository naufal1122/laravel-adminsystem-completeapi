                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="{{ $URL . '/user96' }}"
                                                method="POST">
                                                @csrf
                    ...
                    <br>
                            <div class="card card-success card-outline">
                                ...
                                <div class="card-header text-center bg-dark text-white mb-2">
                                    ...
                                    @if (!$is_preview)
                                        ...
                                        <form enctype='multipart/form-data' action="{{ $URL . '/user96/photo' }}"
                                            method="POST">
                                            @csrf
                            ...
                            <div class="card card-danger card-outline">
                                ...
                                <div class="card-header text-center bg-dark text-white mb-2">
                                    ...
                                    @if (!$is_preview)
                                    <form enctype='multipart/form-data' action="{{ $URL . '/user96/photoKTP' }}"
                                            method="POST">
                                            @csrf
